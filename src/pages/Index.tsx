    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto animate-fade-in">
          <Badge className="mb-6 px-4 py-2 text-sm font-medium education-gradient text-white">
            🚀 Revolução na Educação com IA
          </Badge>
          
          <h1 className="text-5xl md:text-7xl font-bold font-display mb-6 bg-gradient-to-r from-education-600 to-success-600 bg-clip-text text-transparent">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button size="lg" asChild className="text-lg px-8 py-6 education-gradient hover:opacity-90 transition-opacity">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow group">
                <CardHeader>
                  <div className="mx-auto p-4 rounded-full bg-education-50 text-education-600 group-hover:bg-education-100 transition-colors w-fit">
                    {feature.icon}
                  </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="text-center">
                  <div className="w-16 h-16 rounded-full education-gradient text-white text-2xl font-bold flex items-center justify-center mx-auto mb-4">
                    {item.step}
                  </div>
